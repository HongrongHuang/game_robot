...
def type_user_vip_login_info(num):
    if num == 0:
        typer("hhr_7726301@126.com")
        pressEnter()
        typer("qawsedrf")
    elif num == 1:
        typer("329073497@qq.com")
        pressEnter()
        typer("qawsedrf")
        
def type_user_login_info(account,password):
    typer(account)
    pressEnter()
    typer(password)
    
    
def type_user_login_account_num(num):
    account_list = [
    {'username': 'hhr00', 'password':'1q2w3e'},
    {'username': 'hhr01', 'password':'1q2w3e'},
    {'username': 'hhr02', 'password':'1q2w3e'},
    {'username': 'hhr03', 'password':'1q2w3e'},
    {'username': 'hhr04', 'password':'1q2w3e'},
    {'username': 'hhr05', 'password':'1q2w3e'},
    ]
    type_user_login_info(account_list[num]['username'], account_list[num]['password'])
...
def main():
    ...
    pressEnter()
    type_user_login_account_num(0)
    pressEnter()
    type_user_login_account_num(5)
